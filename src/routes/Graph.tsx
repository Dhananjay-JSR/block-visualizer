...
import ReactFlow, { useNodesState, useEdgesState, addEdge, Edge, Node, Controls, MiniMap, Background, Connection, Handle, Position, Panel, useReactFlow, getRectOfNodes, getTransformForBounds } from 'reactflow';
...
function CustomNodder({ data, isConnectable, selected }: any) {
    ...
    return (
        <>
            ...
            <div className="relative flex justify-center items-center flex-col">
                ...
                <div className={`absolute top-full  ${selected ? "bg-white border-2 p-2 rounded-md" : "max-w-[52px] truncate"}`}>
...
function DownloadButton() {
    ...
    return (
        <Panel position="top-right">
            <button className="font-semibold border-2 p-2 rounded-md hover:bg-gray-300 hover:transition-all  transition-all" onClick={onClick}>
                Save Graph Locally
            </button>
        </Panel>
    );
